...
# Scene XML path (in lerobot-gym repo)
LEROBOT_GYM_PATH = Path(__file__).parent.parent.parent / "lerobot-gym"
DEFAULT_SCENE_XML = LEROBOT_GYM_PATH / "scenes" / "so101_with_wrist_cam.xml"
...
class SO100Sim(Robot):
    ...
    def _init_vr(self):
        try:
            # Import VR renderer from lerobot-gym
            import sys
            sys.path.insert(0, str(LEROBOT_GYM_PATH))
